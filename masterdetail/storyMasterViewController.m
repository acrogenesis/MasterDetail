...
#import "storyMasterViewController.h"

#import "storyDetailViewController.h"

@interface storyMasterViewController () {
    NSMutableArray *perfiles;
    
}
@end

@implementation storyMasterViewController
...
- (void)viewDidLoad
{
    ...
    NSMutableArray *nombre = [[NSMutableArray alloc] initWithObjects: @"juanito", @"pepito",nil];
    
    NSMutableArray *email = [[NSMutableArray alloc] initWithObjects:@"juanito@email.com", @"pepito@email.com", nil];
